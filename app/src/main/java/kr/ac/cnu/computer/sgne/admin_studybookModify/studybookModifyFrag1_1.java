...
public class studybookModifyFrag1_1 extends Fragment {

    public studybookModifyFrag1_1(){
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.studybook_modify_fragment1_1, container, false);
    }
}
